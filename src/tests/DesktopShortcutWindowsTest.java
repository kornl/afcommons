...
public class DesktopShortcutWindowsTest {
    public static void main(String[] args) {
        try {
            ...
            WindowsDesktopShortcut sc = new WindowsDesktopShortcut(d, "Test1");
            sc.setExec(new File("C:\\Programme\\Adobe\\Reader 8.0\\Reader\\acrord32.exe"));
            sc.createDesktopEntry();
            sc = new WindowsDesktopShortcut(d, "Test2");
            sc.setExec(new File("C:\\Programme\\Adobe\\Reader 8.0\\Reader\\acrord32.exe"));
